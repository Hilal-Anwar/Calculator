...
public class DensityLayout implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (int x=0;x<observableList.size();x++) hashMap.put(observableList.get(x).getText(),densityConversionData[x]);
    }
