...
public class VolumeLayout implements Initializable
{
    Double []volumeConversionData={1.0,1.E-6,0.0001,2.832E-2,1.639E-5,231*1.639E-5,(231*639E-5)/4,(231*639E-5)/8,231/128*1.639E-5,277.4*1.639E-5};
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        for (int x=0;x<observableList.size();x++) hashMap.put(observableList.get(x).getText(),volumeConversionData[x]);
    }
